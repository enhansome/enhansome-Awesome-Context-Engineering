...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,264 | 🐛 350 | 🌐 Python | 📅 2026-09-24 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
