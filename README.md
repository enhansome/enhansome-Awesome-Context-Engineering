...
* [davidkimai/Context-Engineering: "Context engineering is the delicate art and science of filling the context window with just the right information for the next step." ](https://github.com/davidkimai/Context-Engineering) ⭐ 9,242 | 🐛 3 | 🌐 Python | 📅 2026-02-27
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,124 | 🐛 316 | 🌐 Python | 📅 2026-09-07 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
