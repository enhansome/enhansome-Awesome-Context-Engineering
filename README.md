...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 926 | 🐛 203 | 🌐 Python | 📅 2026-08-18 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
