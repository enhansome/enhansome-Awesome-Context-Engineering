...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,189 | 🐛 363 | 🌐 Python | 📅 2026-09-17 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
