...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,237 | 🐛 417 | 🌐 Python | 📅 2026-09-21 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
