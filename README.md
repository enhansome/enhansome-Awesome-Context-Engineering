...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,185 | 🐛 369 | 🌐 Python | 📅 2026-09-18 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
