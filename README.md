...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 981 | 🐛 160 | 🌐 Python | 📅 2026-08-25 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
