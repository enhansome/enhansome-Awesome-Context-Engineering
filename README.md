...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,280 | 🐛 347 | 🌐 Python | 📅 2026-09-25 - Multi-agent orchestrator with context-aware model routing. Routes tasks to optimal models based on complexity, manages context across parallel agents.
